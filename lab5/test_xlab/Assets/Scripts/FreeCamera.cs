...
public class FreeCamera : MonoBehaviour
{
	...
	public void SetBoxColliderSize()
	{
		...
		//boxCollider.size = new Vector3(boxCollider.size.x, dist + 2, 0.1f);
...
//			mainCamera.transform.localEulerAngles = new Vector3(-rotY, rotX, 0);
	...
	void FixedUpdate()
	{
		//body.AddForce(new Vector3(direction.normalized.x, 0, direction.normalized.z) * speed * acceleration);
